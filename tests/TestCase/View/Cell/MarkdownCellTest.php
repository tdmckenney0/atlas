...
use App\View\Cell\MarkdownCell;
use Cake\TestSuite\TestCase;

/**
 * App\View\Cell\MarkdownCell Test Case
 */
class MarkdownCellTest extends TestCase
{
     ...
     * Test subject
     *
     * @var \App\View\Cell\MarkdownCell
     */
    public $Markdown;
    ...
    public function setUp()
    {
        ...
        $this->Markdown = new MarkdownCell($this->request, $this->response);
    }
