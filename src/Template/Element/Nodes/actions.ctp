<ul class="menu-list">
    ...
    <?php echo $this->element('menulistitem', ['icon' => 'fas fa-file-pdf', 'text' => 'Export to PDF', 'link' => ['controller' => 'Nodes', 'action' => 'export', $node->id, '_ext' => 'pdf']]); ?>
    <?php echo $this->element('menulistitem', ['icon' => 'fas fa-file-archive', 'text' => 'Export to Zip', 'link' => ['controller' => 'Nodes', 'action' => 'export', $node->id, '_ext' => 'zip']]); ?>
