...
return [
    'nextActive' => '<li><a class="pagination-link" rel="next" href="{{url}}"><span aria-hidden="true">&raquo;</span></a></li>',
    'nextDisabled' => '<li><a class="pagination-link" href="" onclick="return false;" disabled><span aria-hidden="true">&raquo;</span></a></li>',
